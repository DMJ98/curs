const rateOneButton = document.querySelector(
  '.feedback-rate-button:first-of-type'
);
...
const secondStepContainerSpan = document.querySelector(
  '.second-step-container span'
);
...
const moveToTheNextStep = () => {
  if (selectedRateNumber > 0) {
    ...
    secondStepContainerSpan.innerText = selectedRateNumber;
  } else {
